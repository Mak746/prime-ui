import { ADMIN_PREFIX, ActivityTitle, PATIENTS_PREFIX, PROFESSIONAL_PREFIX, Roles } from '@app/shared';
import {
  Controller,
  Get,
  HttpCode,
...
@ApiBearerAuth()
@Controller('app/' + PROFESSIONAL_PREFIX + 'notifications')
@Roles('PROFESSIONAL_USER')
export class AppProfessionalNotificationController {
  constructor(
