import type { LoginViaTelegramParams, TelegramAuthCookies, TelegramSessionToken } from './types/LoginViaTelegramParams';
import type { TelegramUser } from './types/TelegramUser';

const TELEGRAM_BASE_URL = 'https://oauth.telegram.org';
// https://oauth.telegram.org/auth?bot_id=6824594124&origin=https%3A%2F%2F2f6b-196-190-62-121.ngrok-free.app&embed=1&return_to=https%3A%2F%2F2f6b-196-190-62-121.ngrok-free.app%2Fauth%2Flogin%3FreturnUrl%3D%252F
// https://oauth.telegram.org/embed/wecare_test_auth_bot?origin=https%3A%2F%2F2f6b-196-190-62-121.ngrok-free.app&embed=1&return_to=https%3A%2F%2F2f6b-196-190-62-121.ngrok-free.app%2Fauth%2Flogin%3FreturnUrl%3D%252F&size=large&request_access=write
...
function loginStatusCheck(
  ...
  return new Promise((resolve, reject) => {
    const process = async () => {
      try {
        const result = await checkTelegramLoginStatus({ botId, origin, phone }, { stel_ssid, stel_tsession });
